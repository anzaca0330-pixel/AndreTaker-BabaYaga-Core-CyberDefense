# 🛡️ CHRIS BÁEZ — EASY STEP-BY-STEP ACTION PLAN (DEADLINE: FRIDAY, SEPT 4, 2026)

**Lead Investigator:** Johannes (Andrea Zabala Cárcamo / AnZaCa / AndreTaker)  
...
## 🔒 GOLDEN RULE: PRIVACY FIRST (DO NOT SUBMIT PERSONAL FILES)

> [!CAUTION]
> **DO NOT ATTACH PERSONAL FILES:** Never share personal receipts, personal insurance claim PDFs, PLA academic essays, or private family chat logs. All personal items are kept strictly offline. Transmit ONLY the 5 verified forensic documents listed below.

---

## 🔗 EXACT WEB LINKS FOR CHRIS BAEZ

1. **FBI IC3 Complaint Portal:** [https://www.ic3.gov/Home/FileComplaint](https://www.ic3.gov/Home/FileComplaint)
2. **IACHR / CIDH Individual Petition e-Filing Portal:** [https://www.oas.org/en/iachr/portal/](https://www.oas.org/en/iachr/portal/) (or Spanish: [https://www.oas.org/es/cidh/portal/](https://www.oas.org/es/cidh/portal/))
3. **IACHR Precautionary Measures Direct Emails:** `cidhmedidas@oas.org` & `cidhdenuncias@oas.org`

---

## 📅 DAY-BY-DAY EASY MICRO-STEPS

### 🗓️ TUESDAY, SEPT 1 — STEP 1: PREPARATION & FILE CHECK
- [ ] **Step 1.1:** Open your computer and locate the repository folder: `03_DOCUMENTACION/SESION_01_ENTREGABLES_LEGALES/`.
- [ ] **Step 1.2:** Confirm you have these 5 forensic files ready (in Markdown or PDF):
  1. [`DEMANDA_MEDIDAS_CAUTELARES_CIDH_BILINGUAL.md`](file:///home/andrea-zabala-c/AndreTaker---AnZaCa-Rep/03_DOCUMENTACION/SESION_01_ENTREGABLES_LEGALES/DEMANDA_MEDIDAS_CAUTELARES_CIDH_BILINGUAL.md)
  2. [`AUDITORIA_GLOBAL_3_DISCOS_CONSOLIDADO.md`](file:///home/andrea-zabala-c/AndreTaker---AnZaCa-Rep/03_DOCUMENTACION/AUDITORIA_GLOBAL_3_DISCOS_CONSOLIDADO.md)
  3. [`INFORME_FORENSE_AUDITORIA_LOGS_Y_BIOS.md`](file:///home/andrea-zabala-c/AndreTaker---AnZaCa-Rep/03_DOCUMENTACION/SESION_01_ENTREGABLES_LEGALES/INFORME_FORENSE_AUDITORIA_LOGS_Y_BIOS.md)
  4. [`INFORME_FORENSE_ANOMALIAS_TELECOMUNICACIONES.md`](file:///home/andrea-zabala-c/AndreTaker---AnZaCa-Rep/03_DOCUMENTACION/SESION_01_ENTREGABLES_LEGALES/INFORME_FORENSE_ANOMALIAS_TELECOMUNICACIONES.md)
  5. [`DICTAMEN_PERICIAL_FORENSE_FINAL.md`](file:///home/andrea-zabala-c/AndreTaker---AnZaCa-Rep/03_DOCUMENTACION/SESION_01_ENTREGABLES_LEGALES/DICTAMEN_PERICIAL_FORENSE_FINAL.md)
...
- [ ] **Step 2.4:** Attach the 3 technical proof files:
  ...
  - `INFORME_FORENSE_ANOMALIAS_TELECOMUNICACIONES.md`
  - Screenshot Folder: `04_EVIDENCIA_GRAFICA/EVIDENCIA_PURGA_BIOS_NVRAM/`
- [ ] **Step 2.5:** Click **Submit** and save your **IC3 Complaint Confirmation Number**.
...
- [ ] **Step 3.4:** Upload / Attach the legal files:
  ...
  - `AUDITORIA_GLOBAL_3_DISCOS_CONSOLIDADO.md`
  - `ORBITA_2_MATRIZ_JURIDICA_CIDH.md`
- [ ] **Step 3.5:** Click **Submit / Send** on the ORSNAsco account portal and save your transmission receipt.
...
*“Tycho measures the data, Baba Yaga unearths the roots, Kepler harmonizes the orbits, and Chris Báez executes the legal shield via ORSNAsco.”*
