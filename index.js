...
const TRANSLATIONS = {
  es: {
    ...
    manifesto_ritual_quote2: "\"Podemos sobrevivir en el infierno, conocemos las bóvedas del infierno, pero no pertenecemos ahí... simplemente escogemos. Y escoger estar del lado de los buenos requiere mucho más coraje y agallas, porque sabes exactamente a lo que te estás enfrentando. Pero también podemos ser unos diablos como ellos si la situación lo exige.\" — Andrea Zabala Cárcamo (AnZaCa)",
